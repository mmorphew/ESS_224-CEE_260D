...
## 1. Request Parameters  
    ...
    Date Completed:** 2021-04-29T03:04:18.544170  

    Id: 57b18b10-a32e-45ab-8480-235473bc0ebf  
    ...
    Details:  
        ...
        Layers:  
            ...
            LE_500m (MOD16A2.006)  
            ET_QC_500m (MOD16A2.006)  
            LE_500m (MYD16A2.006)  
            ET_QC_500m (MYD16A2.006)  
...
- Comma-separated values file with data extracted for a specific product
  - ne-pm-mod-MOD16A2-006-results.csv
- Comma-separated values file with data extracted for a specific product
  - ne-pm-mod-MYD16A2-006-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - ne-pm-mod-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - ne-pm-mod-request.json
- xml file
  - ne-pm-mod-MOD16A2-006-metadata.xml
- xml file
  - ne-pm-mod-MYD16A2-006-metadata.xml  
...
- Running, S., Mu, Q., Zhao, M. (2017). MOD16A2 MODIS/Terra Net Evapotranspiration 8-Day L4 Global 500m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2021-04-29 from https://doi.org/10.5067/MODIS/MOD16A2.006. Accessed April 29, 2021.
- Running, S., Mu, Q., Zhao, M. (2017). MYD16A2 MODIS/Aqua Net Evapotranspiration 8-Day L4 Global 500m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2021-04-29 from https://doi.org/10.5067/MODIS/MYD16A2.006. Accessed April 29, 2021.
