...
## 1. Request Parameters  
    ...
    Name: nebraska_modis_vi  

    Date Completed:** 2021-04-29T04:42:25.970187  

    Id: e504f7c8-f8c7-4b67-b51a-8597dd11f096  
    ...
    Details:  
        ...
        Layers:  
            ...
            _250m_16_days_composite_day_of_the_year (MOD13Q1.006)  
            _250m_16_days_pixel_reliability (MOD13Q1.006)  
            _250m_16_days_EVI (MYD13Q1.006)  
            _250m_16_days_NDVI (MYD13Q1.006)  
            _250m_16_days_VI_Quality (MYD13Q1.006)  
            _250m_16_days_composite_day_of_the_year (MYD13Q1.006)  
            _250m_16_days_pixel_reliability (MYD13Q1.006)  
    
        Coordinates:  

            Ne1, , 41.16506, -96.47664  
            Ne2, , 41.16487, -96.4701  
            Ne3, , 41.17967, -96.43965  
...
- Comma-separated values file with data extracted for a specific product
  - nebraska-modis-vi-MOD13Q1-006-results.csv
- Comma-separated values file with data extracted for a specific product
  - nebraska-modis-vi-MYD13Q1-006-results.csv
- Text file with data pool URLs for all source granules used in the extraction
  - nebraska-modis-vi-granule-list.txt
- JSON request file which can be used in AppEEARS to create a new request
  - nebraska-modis-vi-request.json
- xml file
  - nebraska-modis-vi-MOD13Q1-006-metadata.xml
- xml file
  - nebraska-modis-vi-MYD13Q1-006-metadata.xml  
...
- Didan, K. (2015). MOD13Q1 MODIS/Terra Vegetation Indices 16-Day L3 Global 250m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2021-04-29 from https://doi.org/10.5067/MODIS/MOD13Q1.006. Accessed April 29, 2021.
- Didan, K. (2015). MYD13Q1 MODIS/Aqua Vegetation Indices 16-Day L3 Global 250m SIN Grid V006. NASA EOSDIS Land Processes DAAC. Accessed 2021-04-29 from https://doi.org/10.5067/MODIS/MYD13Q1.006. Accessed April 29, 2021.

## 9. Software Citation  

AppEEARS Team. (2020). Application for Extracting and Exploring Analysis Ready Samples (AppEEARS). Ver. 2.58. NASA EOSDIS Land Processes Distributed Active Archive Center (LP DAAC), USGS/Earth Resources Observation and Science (EROS) Center, Sioux Falls, South Dakota, USA. Accessed April 29, 2021. https://lpdaacsvc.cr.usgs.gov/appeears
